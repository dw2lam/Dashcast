...
import { CabinScreen, DemoStage, ExtendVisual, McuVisual, SoundVisual } from '../../../src/demo';
...
function Vis() {
  ...
  const V = q.get('vis') === 'mcu' ? McuVisual : q.get('vis') === 'extend' ? ExtendVisual : SoundVisual;
  return (
